...
#            #class = "card-button",
#            actionButton(
#              inputId = "r_change_center_button",
...
#        ),
        ...
        column(
          ...
          div(
            ...
            uiOutput("r_select_any_global_ui"))
        ),
        ...
        column(
          ...
          div(
            ...
            uiOutput("r_taula_switch_resum_ui")
          )
        ),
        ...
        column(
          ...
          div(
            downloadLink(
              outputId = "r_download_buttons_resum", 
          ...
          #  actionButton("r_ajuda_resum", label = "Com funciona?", icon = icon('question-circle'), class = "qia-down"),
          #  br()
          #),
          #div(
          #  title = "Com s'interpreten la icona de variació i el gràfic resum?",
          #  actionButton("r_int_resum", label = "Interpretació", icon = icon('question-circle'), class = "qia-down"),
          #  br()
          #),
          #div(
          #  style = "margin:10px;",
          #  title = "Descarrega la selecció en format Excel",
          #  uiOutput("r_download_buttons")
      ...
      page_fillable(
        ...
        div(
          ...
          div(
            ...
            uiOutput("r_titol_taula")
          )
        ),
        # Table output with spinner
        withSpinner(uiOutput("r_taula_resum"), color = "#FC8D59"),
        br(),
        hr()
      )
  ),
